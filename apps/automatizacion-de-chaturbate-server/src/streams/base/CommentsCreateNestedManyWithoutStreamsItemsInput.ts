...
@InputType()
class CommentsCreateNestedManyWithoutStreamsItemsInput {
...
export { CommentsCreateNestedManyWithoutStreamsItemsInput as CommentsCreateNestedManyWithoutStreamsItemsInput };
